* import dataset
clear  
import delimited "/Users/jinghan/Desktop/basel_proj/data/processed/df_for_stata.csv", ///
    case(preserve) ///
    stringcols(8 10 11) ///
    numericcols(2 3 4 5 6 7 9 12 13 14 15 16 17 18)
...
// ssc install ftools
// ssc install reghdfe
reghdfe roe TP t1cr stock_price mkt_cap leverage_ratio rir gdp cpi, absorb(GSIB tq_var) vce(cluster country)
